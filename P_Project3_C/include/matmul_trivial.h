...
#define TrivialMatrixGetElement(matrix, i, j) ((matrix)->data[(matrix)->columnCount*(i)+(j)])
 ...
 */
struct TrivialMatrix* matrix_element_by_element_linear_combinations_simd(const struct TrivialMatrix* matrixA, const struct TrivialMatrix* matrixB,
